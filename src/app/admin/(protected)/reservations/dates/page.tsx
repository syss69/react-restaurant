...
import { addBlockedDateAction, removeBlockedDateAction } from "@/src/app/admin/actions";

export const metadata = {
  title: "Admin — Réservations — Dates bloquées | Mitaka",
};
...
export default async function AdminReservationDatesPage() {
